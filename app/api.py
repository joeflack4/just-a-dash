...
class ApiAuth:
    ...
    def basic_oms_admin(cls, **kwargs):
        ...
        if user_logged_in:
            if current_user.oms_role != 'basic' or current_user.oms_role != 'super' \
                    or current_user.oms_role != 'master':
    ...
    def master_oms_admin(cls, **kwargs):
        user_logged_in = cls.logged_in()
        if user_logged_in:
            if current_user.oms_role != 'master':
    ...
    def basic_crm_admin(cls, **kwargs):
        ...
        if user_logged_in:
            if current_user.crm_role != 'basic' or current_user.crm_role != 'super' \
                    or current_user.crm_role != 'master':
    ...
    def master_crm_admin(cls, **kwargs):
        user_logged_in = cls.logged_in()
        if user_logged_in:
            if current_user.crm_role != 'master':
    ...
    def basic_hrm_admin(cls, **kwargs):
        ...
        if user_logged_in:
            if current_user.hrm_role != 'basic' or current_user.hrm_role != 'super' \
                    or current_user.hrm_role != 'master':
    ...
    def master_hrm_admin(cls, **kwargs):
        user_logged_in = cls.logged_in()
        if user_logged_in:
            if current_user.hrm_role != 'master':
    ...
    def basic_ams_admin(cls, **kwargs):
        ...
        if user_logged_in:
            if current_user.ams_role != 'basic' or current_user.ams_role != 'super' \
                    or current_user.ams_role != 'master':
    ...
    def master_ams_admin(cls, **kwargs):
        user_logged_in = cls.logged_in()
        if user_logged_in:
            if current_user.ams_role != 'master':
    ...
    def basic_mms_admin(cls, **kwargs):
        ...
        if user_logged_in:
            if current_user.mms_role != 'basic' or current_user.mms_role != 'super' \
                    or current_user.mms_role != 'master':
    ...
    def master_mms_admin(cls, **kwargs):
        user_logged_in = cls.logged_in()
        if user_logged_in:
            if current_user.mms_role != 'master':
